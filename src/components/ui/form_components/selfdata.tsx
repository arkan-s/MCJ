...
import { OrgIntHistoryComponents } from '@/components/ui/form_components/OrgIntHistoryComp';
...
export default function Form() {
    ...
    const components = [
        ...
        { component: [<OrgIntHistoryComponents />], label: 'Riwayat Organisasi Internal' },
